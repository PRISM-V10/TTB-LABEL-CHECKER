...
**Field scope:** This prototype checks three fields, brand name, ABV, and government warning, chosen because they were the fields stakeholders described as the most repetitive and time-consuming part of manual review. Class/type designation, net contents, producer name/address, and country of origin were left out of this prototype's automated checks; the same OCR-and-match approach used here would extend to them directly, but the three included fields were prioritized to keep the prototype focused given the project timeline.
